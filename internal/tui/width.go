...
// wideRuneIntervals is generated from the Wide and Fullwidth values in
// Unicode's EastAsianWidth data. Those values also cover default emoji
// presentation characters, including the compass used by the TUI fixtures.
