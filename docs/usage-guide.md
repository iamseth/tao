...
toggles repository focus on Plans and Notes. **Done** is always displayed with
up to 15 completed or abandoned plans. **Now** contains in-progress, blocked, reviewed, and other plans with an immediate action
